...
struct SleepReportView: View {
    ...
    private var disclaimerSection: some View {
        Text(String(localized: "Next Sleep is not a medical device. Consult a healthcare professional for sleep apnea diagnosis."))
            .font(.caption2)
    ...
    private func generateReportText() -> String {
        ...
        report += "Note: This report was generated by Next Sleep and is not a medical diagnosis."
